...
public class PickUpToHome extends SequentialCommandGroup {
  /** Creates a new AmpToHome. */
  private Arms m_arms;

  public PickUpToHome(Arms m_arms) {
    ...
    addCommands(
     ...
     new MoveArmsToPosition(m_arms, -1, -7, RobotPrefs.getMiddleTolerance()),
