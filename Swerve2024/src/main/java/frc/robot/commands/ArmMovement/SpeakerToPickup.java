...
public class SpeakerToPickup extends SequentialCommandGroup {
  /** Creates a new AmpToHome. */
  private Arms m_arms;

  public SpeakerToPickup(Arms m_arms) {
    ...
    addCommands(
      ...
      //  new MoveArmsToPosition(m_arms, 11, -18, RobotPrefs.getMiddleTolerance()),
        new MoveArmsToPosition(m_arms, 15, -18, RobotPrefs.getMiddleTolerance()),
