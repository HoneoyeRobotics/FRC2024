...
public class RobotContainer {
                ...
                m_robotDrive.setDefaultCommand(
                                ...
                                new RunCommand(
                                                () -> m_robotDrive.drive(
                                                                ...
                                                                true, true),
                                                m_robotDrive));
                SmartDashboard.putData("Reset Lower Elbow Encoder", new ResetLowerElbowEncoder(m_arms));
                SmartDashboard.putData("Reset Upper Elbow Encoder", new ResetUpperElbowEncoder(m_arms));
        ...
        private void configureButtonBindings() {
                ...
                buttonBoard.button(10).onTrue(new MoveLowerElbow(m_arms, 1));
                buttonBoard.button(11).onTrue(new MoveLowerElbow(m_arms, -1));
                buttonBoard.button(9).onTrue(new MoveUpperElbow(m_arms, 1));
                buttonBoard.button(3).onTrue(new MoveUpperElbow(m_arms, -1));
        }
